        ...
        return {
          ...
          template: [
            '<div class="ui-tabs-scrollable" ng-class="{\'show-drop-down\': !hideDropDown}">',
              ...
              ' ng-disabled="disableLeft" class="btn btn-link nav-button left-nav-button"' +
              ...
              ' ng-disabled="disableRight" class="btn btn-link nav-button right-nav-button"' +
              ' tooltip-placement="{{tooltipRightDirection}}" uib-tooltip-html="tooltipRightHtml"></button>',
              '<div class="btn-group bootstrap-select" uib-dropdown dropdown-append-to-body ng-hide="hideDropDown">',
                '<button type="button" class="btn btn-link" uib-dropdown-toggle></button>',
          ...
          link: function($scope, $el) {
            ...
            $scope.activateTab = function(tab) {
              ...
              angular.forEach($scope.dropdownTabs, function(elem) {
                elem.active = false;
              });
